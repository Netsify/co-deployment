    ...
    <div class="card-body">
        ...
        <form method="post" action="{{ route('proposal.send', [$senderFacility, $receiverFacility]) }}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea name="description" id="details" class="form-control form-control-sm"></textarea>
            </div>
            <div class="mb-3">
            ...
            <button type="submit" class="btn btn-primary">{{ __('proposal.send_proposal') }}</button>
        </form>
    </div>
</div>
