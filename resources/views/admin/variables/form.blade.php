                                ...
                                @foreach(config('app.locales') as $locale)
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <textarea name="description[{{ $locale }}]" id="description_{{ $locale }}"
                                                  rows="3"
                                                  class="form-control form-control-sm @error('description.'.$locale) is-invalid @enderror">{{ old("description.$locale") }}</textarea>
                                ...
                                @foreach(config('app.locales') as $locale)
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <input type="text" name="unit[{{ $locale }}]" id="unit_{{ $locale }}"
                                               class="form-control form-control-sm @error('unit.'.$locale) is-invalid @enderror" value="{{ old("unit.$locale") }}">
                                        @error('unit.'.$locale)
                                        <x-invalid-feedback :message="$message"/>
                                        @enderror
                                    </div>
                            ...
                            <div class="row mb-3">
                                <div class="col col-sm-4">
                                    ...
                                    <input type="number" name="min_val" id="min_val" step="0.01"
                                           class="form-control form-control-sm @error('min_val') is-invalid @enderror" value="{{ old('min_val') }}">
                                    @error('min_val')
                                    <x-invalid-feedback :message="$message"/>
                                    @enderror
                                </div>
                                <div class="col col-sm-4">
                                    ...
                                    <input type="number" name="max_val" id="max_val" step="0.01"
                                           class="form-control form-control-sm @error('max_val') is-invalid @enderror" value="{{ old('max_val') }}">
                                    @error('max_val')
                                    <x-invalid-feedback :message="$message"/>
                                    @enderror
                                </div>
                                <div class="col col-sm-4">
                                    ...
                                    <input type="number" name="default_val" id="default_val" step="0.01"
                                           class="form-control form-control-sm @error('default_val') is-invalid @enderror" value="{{ old('default_val') }}">
                                    @error('default_val')
                                    <x-invalid-feedback :message="$message"/>
                                    @enderror
                                </div>
