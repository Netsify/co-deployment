...
class FacilitiesService
{
    ...
    public static function getEconomicEfficiency(Facility $facility1, Facility $facility2)
    {
         ...
         * А от самих объектов мне по факту нужны только тип первого объекта (дорога он или что там), так как тип второго всегда ИТ и ещё - мне нужна такая штука как длина объекта (протяжённость)
